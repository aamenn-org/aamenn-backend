...
export class AddGoogleRefreshToken1773095089206 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // Drop legacy constraints/indexes/columns only if they exist (safe for fresh DBs)
        await queryRunner.query(`ALTER TABLE "files" DROP CONSTRAINT IF EXISTS "FK_files_video_stream"`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT IF EXISTS "fk_users_avatar_file"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_album_files_album_id_order_index"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_files_user_id_deleted_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_files_content_hash"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_files_user_id_created_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_files_video_stream"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_role_is_active"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_last_login_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_share_links_owner_created"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_share_links_resource"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_share_links_expires_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_refresh_tokens_token_hash"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_refresh_tokens_user_id_is_revoked"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_download_logs_user_id_created_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_download_logs_created_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_CONTACTS_GOOGLE_ID"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_CONTACTS_USER_ID"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_CONTACTS_PHONE"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN IF EXISTS "cipher_thumb_small_key"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN IF EXISTS "cipher_thumb_medium_key"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN IF EXISTS "blurhash"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN IF EXISTS "cipher_thumb_large_key"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN IF EXISTS "video_stream_id"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN IF EXISTS "storage_layout"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN IF EXISTS "b2_manifest_path"`);
        await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN IF EXISTS "last_sync_at"`);
        await queryRunner.query(`ALTER TABLE "users" ADD IF NOT EXISTS "google_refresh_token" text`);
        await queryRunner.query(`COMMENT ON COLUMN "users"."trash_retention_days" IS NULL`);
        // Rename share_resource_type only if old name still exists
        await queryRunner.query(`
          DO $$ BEGIN
            IF EXISTS (SELECT 1 FROM pg_type WHERE typname = 'share_resource_type') THEN
              ALTER TYPE "public"."share_resource_type" RENAME TO "share_resource_type_old";
            END IF;
          END $$;
        `);
        await queryRunner.query(`
          DO $$ BEGIN
            IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'share_links_resource_type_enum') THEN
              CREATE TYPE "public"."share_links_resource_type_enum" AS ENUM('file', 'album');
            END IF;
          END $$;
        `);
        ...
        await queryRunner.query(`
          DO $$ BEGIN
            IF EXISTS (SELECT 1 FROM pg_type WHERE typname = 'share_resource_type_old') THEN
              DROP TYPE "public"."share_resource_type_old";
            END IF;
          END $$;
        `);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ALTER COLUMN "created_at" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN IF EXISTS "google_contact_id"`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_ea30055665f2fee9e3df4814fa" ON "share_links" ("expires_at") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_dfdbaf66cf64f42ac70688d799" ON "share_links" ("resource_type", "resource_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_40cde31c388a870f0ce9d6da9a" ON "share_links" ("owner_user_id", "created_at") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_a7838d2ba25be1342091b6695f" ON "refresh_tokens" ("token_hash") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_14187aa4d2d58318c82c62c7ea" ON "refresh_tokens" ("user_id", "is_revoked") `);
    }
